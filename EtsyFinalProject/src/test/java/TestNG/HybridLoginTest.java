...
public class HybridLoginTest {
    ...
    public void setUp() throws Exception {
        ...
        htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "\\Report\\LoginTest.html");
        extent = new ExtentReports();
        extent.attachReporter(htmlReporter);
    }

    @Test(dataProvider = "hybridData")
    public void LoginTest(String fileLocation, String sheetName) throws IOException, Exception {
